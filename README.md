...
- **cracker_v1.py** : Version de base, mono-cœur et caractères simples
...
- Python 3.x
- Les autres modules sont inclus par défaut dans python, pas de `pip install` ou de `.venv` nécessaire
